        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToUserId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 450, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    WorkItemCommentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WorkItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", maxLength: 450, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkItemComments", x => x.WorkItemCommentId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkItemComments_WorkItemId_CreatedOnUtc",
