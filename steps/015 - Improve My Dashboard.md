...
Update the implementation of DashboardService with the following
...
This changes from 5x Queries, to 2

Still hits the DB on every page load, which maybe isn't the best bet!  Lets continue!
